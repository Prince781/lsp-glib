namespace Lsp {
    ...
    public class InitializeParams {
        ...
        public InitializeParams (WorkspaceFolder primary_workspace,
            ...
            string root_uri_string =
                Uri.join (UriFlags.NONE,
                          primary_workspace.uri.get_scheme (),
                          primary_workspace.uri.get_userinfo (),
                          primary_workspace.uri.get_host (),
                          primary_workspace.uri.get_port (),
                          primary_workspace.uri.get_path (),
                          primary_workspace.uri.get_query (),
                          primary_workspace.uri.get_fragment ());
